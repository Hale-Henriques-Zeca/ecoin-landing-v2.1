        ...
        >
          {[...slides, ...slides].map((item, i) => (
            <motion.div
              ...
              className="min-w-[220px] sm:min-w-[280px] md:min-w-[320px] bg-gradient-to-b 
                        from-[#111] to-[#000] border border-[#D4AF37]/30 rounded-2xl 
                        shadow-[0_0_15px_rgba(212,175,55,0.2)] p-4 sm:p-5 flex flex-col 
                        items-center text-center hover:border-[#D4AF37]/70 transition-all duration-300"
            >

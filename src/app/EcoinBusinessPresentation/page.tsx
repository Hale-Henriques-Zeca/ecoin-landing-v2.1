        ...
        <div className="max-w-5xl mx-auto text-center space-y-16">
          ...
          >
            ...
            <ul className="list-disc list-inside space-y-3 text-gray-300 leading-relaxed">
              ...
              <li>
                Staking automatizado via bot Telegram (temporário) e painel Web3
                da EBC DEX (E-Swap);
              </li>
              <li>
              ...
              <li>
                Integração total com PancakeSwap, EBC, EBC DEX (E-Swap) e
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              EdenKingDom através de listagens DEX, CEX, EBC e EBC DEX (E-Swap),
...
>
  ...
  <div className="max-w-5xl mx-auto text-left text-gray-200 space-y-8">
    ...
    <ul className="list-disc list-inside text-gray-300 text-sm sm:text-base leading-relaxed space-y-2">
      ...
      <li>🔢 Modelo de Staking – Pagamentos dos Epochs Diários</li>
      <li>💎 Origem dos Fundos (Epoch Pool)</li>
      <li>📊 Earnings Distribution – Cálculo Diário</li>
      <li>🔄 Variações do APR (Annual Percentage Rate)</li>
      <li>💳 Retirada e Integração com Pré-Venda</li>
      <li>📈 Faixas de APR Diário – Exemplos e Cenários</li>
      <li>🧾 Transparência Pública – Nada Escondido</li>
      <li>🧮 Exemplo Numérico Completo – Cálculo Diário do Pool</li>
...
>
  ...
  <div className="max-w-5xl mx-auto text-left text-gray-200 space-y-10">
    ...
    <div className="space-y-3 mt-8">
      ...
      <p className="text-sm sm:text-base leading-relaxed text-gray-300">
        A nossa Exchange - EBC permitirá:
      </p>
      <ul className="list-disc list-inside text-gray-400 ml-4 space-y-1">
...
>
  ...
  <div className="max-w-5xl mx-auto text-left text-gray-200 space-y-10">
    ...
    <div className="mt-10">
      ...
      <p className="text-sm sm:text-base leading-relaxed text-gray-300">
        Os nossos caixas eletrônicos de criptomoedas (<strong>E-Pay Crypto ATM & E-Pay Vault, E-Pay Banking Card, E-Wallet, E-Chain, E-Shareholders, EBC-CEX, EBC-DEX (E-Swap), etc</strong>) trabalharão exclusivamente com <strong>E-Coin</strong>.
      </p>
...
>
  ...
  <div className="max-w-5xl mx-auto text-left text-gray-200 space-y-12">
    ...
    <div className="border-l-4 border-[#F59E0B]/70 pl-6">
      ...
      <p className="text-gray-300 leading-relaxed mb-3">
        Modelos como o <strong>Xitique</strong> ou
    ...
    <div className="border-l-4 border-[#22C55E]/70 pl-6">
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        <li>
          ...
          nos serviços <strong>Xitique</strong> ou <strong>Buy Your Seat</strong>.
        </li>
        <li>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-left">
      ...
      <div className="bg-black/40 border border-[#22C55E]/30 rounded-2xl p-6 backdrop-blur-sm">
        ...
        <p className="text-gray-300 leading-relaxed">
          ...
          distribuídas por <strong>épocas (epochs)</strong>,
...
>
  ...
  <div className="max-w-6xl mx-auto text-center text-gray-200 space-y-14">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-left">
      ...
      <div className="bg-black/40 border border-[#F59E0B]/30 rounded-2xl p-6 backdrop-blur-sm">
        <h3 className="text-lg font-bold text-[#F59E0B] mb-3">
          🛡️ Proteção Antidumping & Liquidação 
        </h3>
        <p className="text-gray-300 leading-relaxed">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 text-left">
      ...
      <div className="bg-black/40 border border-[#22C55E]/30 rounded-2xl p-6 backdrop-blur-sm">
        ...
        <p className="text-gray-300 leading-relaxed">
          ...
          incluindo a <strong>EBC DEX (E-Swap)</strong>,
          <strong>PancakeSwap</strong> e outras DEXs,
          ao preço inicial de <strong> $0,30</strong>.
        </p>
      </div>
...
>
  ...
  <div className="max-w-6xl mx-auto text-gray-200 space-y-14">
    ...
    <h2 className="text-2xl sm:text-4xl font-extrabold text-[#3B82F6] text-center">
      🧮 Modelo de Staking: Pagamentos dos Epochs Diários
    </h2>
    ...
    <div className="border-l-4 border-[#D4AF37]/70 pl-6 max-w-4xl mx-auto">
      ...
      <p className="text-gray-300 leading-relaxed mb-3">
        O sistema de <strong>Epochs</strong> é o mecanismo que define
...
>
  ...
  <div className="max-w-6xl mx-auto text-gray-200 space-y-14">
    ...
    <div className="max-w-4xl mx-auto border-l-4 border-[#22C55E]/70 pl-6">
      ...
      <p className="text-gray-400 leading-relaxed">
        O <strong>Epoch Pool</strong> (fundo de recompensas diárias)
    ...
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-6xl mx-auto">
      ...
      <div className="bg-black/40 border border-[#F59E0B]/30 rounded-2xl p-6 backdrop-blur-sm">
        ...
        <p className="text-gray-300 leading-relaxed">
          ...
          exchanges internas e externas,
          reforçam continuamente o Epoch Pool.
        </p>
      </div>
    ...
    <div className="max-w-4xl mx-auto border-l-4 border-[#D4AF37]/70 pl-6">
      ...
      <p className="text-gray-300 leading-relaxed mb-3">
        ...
        <strong> distribui apenas o que já existe no pool</strong>.
      </p>
      <p className="text-gray-400 leading-relaxed">
        Se não há fundos no Epoch Pool,
...
>
  ...
  <div className="max-w-6xl mx-auto text-gray-200 space-y-14">
    ...
    <div className="max-w-4xl mx-auto border-l-4 border-[#3B82F6]/70 pl-6">
      <h3 className="text-xl sm:text-2xl font-bold text-[#3B82F6] mb-4">
        🧮 Etapas de Cálculo Diárias (Epoch)
      </h3>
      <ol className="list-decimal list-inside text-gray-300 space-y-2">
        <li>
          O contrato calcula quanto há no
          <strong> pool da época</strong>
          (valor total diário disponível em E-Coin).
        </li>
        <li>
...
>
  ...
  <div className="max-w-6xl mx-auto text-gray-200 space-y-14">
    ...
    <div className="max-w-4xl mx-auto border-l-4 border-[#3B82F6]/70 pl-6">
      <p className="text-gray-300 leading-relaxed mb-3">
        Os rendimentos diários (<strong>APR — Annual Percentage Rate</strong>)
        da <strong>E-Coin</strong> <strong>não são fixos</strong>.
      </p>
      <p className="text-gray-400 leading-relaxed">
        Eles variam conforme o
        <strong> comportamento real do ecossistema</strong>,
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-6xl mx-auto">
      ...
      <div className="bg-black/40 border border-[#22C55E]/30 rounded-2xl p-6 backdrop-blur-sm">
        <h3 className="text-lg font-bold text-[#22C55E] mb-3">
          💧 Tamanho do Pool Diário
        </h3>
        <p className="text-gray-300 leading-relaxed mb-2">
          Se a tesouraria ou as compras da pré-venda aumentam,
          o <strong> pool diário cresce</strong>.
        </p>
        <p className="text-gray-400">
          ➜ Pool maior → <strong>usuários ganham mais</strong><br />
          ➜ Pool menor → <strong>percentuais caem</strong>
        </p>
      </div>
  ...
  <div className="max-w-6xl mx-auto text-gray-200 space-y-14">
    ...
    <div className="max-w-5xl mx-auto border-l-4 border-[#D4AF37]/70 pl-6">
      ...
      <ol className="list-decimal list-inside text-gray-300 space-y-3">
        ...
        <li>
          ...
          <strong> diretamente ao Epoch Pool</strong>.
        </li>
        <li>
    ...
    <div className="max-w-5xl mx-auto border-l-4 border-[#22C55E]/70 pl-6">
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        ...
        <li>
          ...
          no próximo depósito ou retirada.
        </li>
      </ul>
    </div>
    ...
    <div className="max-w-5xl mx-auto border-l-4 border-[#F59E0B]/70 pl-6">
      ...
      <p className="text-gray-300 leading-relaxed mb-3">
        ...
        diretamente na propria DEX: <strong>EBC DEX, PancakeSwap</strong>.
      </p>
      <p className="text-gray-400 leading-relaxed">
  ...
  <div className="max-w-6xl mx-auto text-gray-200 space-y-14">
    ...
    <div className="bg-black/50 border border-[#D4AF37]/30 rounded-2xl p-8 backdrop-blur-sm max-w-5xl mx-auto">
        ...
        <table className="w-full border-collapse text-left">
          ...
          <tbody className="text-gray-300">
            <tr className="border-b border-white/10">
              <td className="py-3 px-4">💰 Pool do dia (E-Coin)</td>
              <td className="py-3 px-4">
                Valor total destinado às recompensas diárias
              </td>
            </tr>
            ...
            <tr className="border-b border-white/10">
              ...
              <td className="py-3 px-4">
                Percentual efetivo pago conforme o pool do dia
              </td>
            </tr>
            ...
            <tr className="border-b border-white/10">
              ...
              <td className="py-3 px-4">
                Links diretos das funções <code>fundPool()</code> e <code>closeEpoch()</code>
              </td>
            </tr>
      ...
      <p className="text-gray-400 text-center mt-6">
        ...
        <strong> canal oficial do Telegram EKD</strong>.
      </p>
    </div>
    ...
    <div className="overflow-x-auto rounded-xl border border-white/10 bg-black/40 backdrop-blur">
      <table className="w-full text-left text-sm sm:text-base">
        ...
        <tbody className="divide-y divide-white/10">
          ...
          <tr>
            <td className="px-4 py-3">🏛 Grupo Telegram EBC</td>
            <td className="px-4 py-3">
              EdenKingDom BuY Crypto (EBC) <br />
          ...
          <tr>
            <td className="px-4 py-3">💼 Grupo WhatsApp EBC</td>
            <td className="px-4 py-3">EdenKingDom Buy Crypto (EBC)</td>
            <td className="px-4 py-3 text-blue-400">
  ...
  <div className="max-w-6xl mx-auto text-gray-200 space-y-12">
    ...
    <div className="border-l-4 border-[#F59E0B]/70 pl-6 space-y-4">
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        ...
        <li>💵 Troca por USDT via PancakeSwap ou por MZN/USD via EdenKingDom Buy Crypto (EBC)</li>
      </ul>
    </div>
...
>
  ...
  <div className="max-w-5xl mx-auto text-gray-200 space-y-12">
    ...
    <div className="border-l-4 border-[#22C55E]/70 pl-6 space-y-4">
      <h3 className="text-xl sm:text-2xl font-bold text-[#22C55E]">
        👣 Passo 4 — Ative o Staking
      </h3>

      <ul className="list-disc list-inside text-gray-300 space-y-2">
        <li>
          💎 Acesse o painel <strong>“E-Coin Staking”</strong>.
        </li>
        <li>
          🖱️ Clique em <strong>Stake E-Coin</strong>,
    ...
    <div className="border-l-4 border-[#3B82F6]/70 pl-6 space-y-4">
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        <li>
          🪙 Seus tokens <strong>E-Coin ficam bloqueados</strong>
          durante o período de staking.
        </li>
        <li>
          💹 Os ganhos diários variam entre
          <strong> 0,1% e 1%</strong>, conforme o desempenho do ecossistema.
        </li>
        <li>
          ⚖️ Recompensas <strong>sustentáveis e proporcionais</strong>
          ao tamanho do pool e ao total em staking.
        </li>
      </ul>
    </div>
...
>
  ...
  <div className="max-w-5xl mx-auto text-gray-200 space-y-12">
    ...
    <div className="text-center">
      <h2 className="text-2xl sm:text-3xl font-extrabold text-[#3B82F6]">
        ⏳ Epochs Diários & Recebimento de Recompensas
      </h2>
      <p className="text-gray-400 mt-3">
    ...
    <div className="border-l-4 border-[#22C55E]/70 pl-6 space-y-4">
      <h3 className="text-xl sm:text-2xl font-bold text-[#22C55E]">
        📅 Como funcionam os Epochs Diários
      </h3>

      <ul className="list-disc list-inside text-gray-300 space-y-2">
        <li>
          ⏱️ A cada <strong>24 horas</strong>, o contrato fecha automaticamente
          um ciclo (<strong>epoch</strong>).
        </li>
        <li>
          💰 O sistema mostra o <strong>total do pool diário</strong>.
        </li>
        <li>
          📈 Exibe o <strong>APR realizado do dia</strong>
          (percentual real pago).
        </li>
        <li>
    ...
    <div className="border-l-4 border-[#3B82F6]/70 pl-6 space-y-4">
      ...
      <h4 className="text-lg font-semibold text-gray-300">
        👣 Passo 6 — Claim, Auto-Claim & Auto-Compounding
      </h4>
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        ...
        <li>
          🔄 Ative o <strong>Auto-Claim (ON/OFF)</strong>
          para recebimento automático a cada epoch.
        </li>
        <li>
          ♻️ Ative o <strong>Auto-Compounding (ON/OFF)</strong>
          para <strong>reinvestir automaticamente</strong>
          seus ganhos diários no staking.
        </li>
      </ul>
    </div>
    ...
    <div className="border-l-4 border-[#22C55E]/70 pl-6 space-y-4">
      ...
      <ul className="list-disc list-inside text-gray-300 space-y-2">
        ...
        <li>
          ...
          <strong> USDT</strong> via <strong>PancakeSwap</strong>
          (par E-Coin/USDT).
        </li>
        <li>
          🏪 <strong>Pague produtos e serviços</strong> dentro do
          <strong> EdenKingDom Marketplace</strong> e em parceiros do ecossistema.
        </li>
      </ul>
    </div>
